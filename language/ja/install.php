...
$lang = array_merge($lang, array(
	...
	'INST_ERR_FATAL_DB'			=> '致命的かつ復元不可能なデータベースエラーが発生しました。指定したユーザーに <code>CREATE TABLES</code> または <code>INSERT</code> などの SQL 命令の実行権限が与えられていない事が原因と考えられます。詳細は下記をご覧ください。まず最初にサーバ管理者にこの事をお問い合わせください。それでも解決しない場合、phpBBサポートフォーラム をご利用ください。',
