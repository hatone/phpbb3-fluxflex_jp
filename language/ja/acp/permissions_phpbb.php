...
$lang = array_merge($lang, array(
	...
	'acl_u_chgcensors'	=> array('lang' => '言語フィルタの無効化', 'cat' => 'post'),
	'acl_u_sig'			=> array('lang' => 'サインの使用', 'cat' => 'post'),

	'acl_u_sendpm'		=> array('lang' => 'プライベートメッセージの送信', 'cat' => 'pm'),
	'acl_u_masspm'		=> array('lang' => '複数のユーザーへプライベートメッセージの送信', 'cat' => 'pm'),
	'acl_u_masspm_group'=> array('lang' => 'グループへプライベートメッセージの送信', 'cat' => 'pm'),
...
$lang = array_merge($lang, array(
	...
	'acl_f_read'		=> array('lang' => 'フォーラムへ入室', 'cat' => 'post'),
	...
	'acl_f_bbcode'		=> array('lang' => '記事で BBCode の使用', 'cat' => 'content'),
	'acl_f_smilies'		=> array('lang' => '記事でスマイリーの使用', 'cat' => 'content'),
	'acl_f_img'			=> array('lang' => '記事で [img] BBCode の使用', 'cat' => 'content'),
	'acl_f_flash'		=> array('lang' => '記事で [flash] BBCode の使用', 'cat' => 'content'),
	...
	'acl_f_postcount'	=> array('lang' => '投稿数のカウント<br /><em>記事が投稿された場合のみカウントされる点にご注意ください。記事が削除、移動された場合にカウント数が影響を受ける事はありません。</em>', 'cat' => 'misc'),
...
$lang = array_merge($lang, array(
	...
	'acl_a_words'		=> array('lang' => '言語フィルタの変更', 'cat' => 'posting'),
	'acl_a_bbcode'		=> array('lang' => 'BBCode の作成', 'cat' => 'posting'),
	'acl_a_attach'		=> array('lang' => 'ファイル添付の設定の変更', 'cat' => 'posting'),
	...
	'acl_a_names'		=> array('lang' => '禁止ユーザー名の管理', 'cat' => 'user_group'),
	...
	'acl_a_email'		=> array('lang' => '一括メールの送信', 'cat' => 'misc'),
