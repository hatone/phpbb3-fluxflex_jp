...
$lang = array_merge($lang, array(
	...
	<br /><br />
	<em>インデクス （ index ） とは索引付けの事であり、具体的には記事が投稿された際に記事の件名と文章中に含まれるキーワードを抜き出してデータベースに保存する事を意味します。検索処理はデータベースに保存されたこのインデクス情報を基にして行われます。phpBB3 では検索バックエンドは Fulltext mysql と Fulltext native がはじめから用意されており、ここでどちらを利用するかを選択できます。 Fulltext native がデフォルトで選択されています。Fulltext mysql を使用するにはデータベースが MySQL である必要があります。</em>',
